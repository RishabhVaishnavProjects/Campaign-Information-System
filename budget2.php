...
else
{
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		$sql2="INSERT INTO copy VALUES('".$product_id."','".$branch_id."','".$alloted_amount."','".$n_o_p."','".$c_duration."')";
...
<ul>
  ...
  <li><a href="R_ANALYSIS.php">RATIO ANALYSIS</a></li>
...
<div id="div1" ng-app="">
  ...
  <tr>
	<td><label>Amount of Return Expected:</label></td><td><input type="number" name="re" placeholder="" class="textbox2" /></td>
  </tr>
  </table>
  </br>
  </br>
...
<td><label style="color: white;font-size: 28px;">Gross Profit:</label></td><td><input type="text" id="h_textbox" name="g_profit" placeholder="" class="textbox" style="color:white;" value="<?php echo $gp ?>"/></td>
</tr>
</table>
</div>
-->
